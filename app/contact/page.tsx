      ...
      <div className="mt-14 mb-14 flex flex-col lg:flex-row lg:justify-between lg:pl-4 xl:pl-20 items-center">
        <div className="flex flex-col items-center lg:items-start space-y-4 mb-14">
          ...
          <p className="w-[350px] sm:w-[500px] md:w-[600px]  text-center lg:text-start font-sans">
            With a steadfast commitment to promoting Catholic priestly formation
            and strengthening family life, our foundation aims to support
            countless individuals and families. Join us in our mission to
            nurture faith and foster strong, resilient communities, Let us help
            you too.
          </p>
        </div>
      ...
      <div className="mt-12 bg-gray-200 p-4">
        <div className="text-center w-full flex flex-col items-center mb-10">
          ...
          <p className="text-center font-sans max-w-[900px]">
            ...
            global community dedicated to promoting Catholic Priestly formation
            and strengthening family life. Together, we can make a difference.
          </p>
        </div>
        ...
        <div className="p-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-14">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="font-sans">
              Follow us on X for insights, the latest news on Catholic priestly
              formation, family life enrichment, and updates on our events,
              programs and initiatives. Stay connected and join us.
            </p>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="font-sans">
              Connect with us on LinkedIn for insightful discussions on Catholic
              Priestly formation and strengthening family life. Explore topics
              that inspire and support the growth of faith communities.
            </p>
            <a
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="font-sans">
              ...
              formation and the sanctity of family life. Share your own stories
              and experiences with us at @fr_stanley_fdn.
            </p>
